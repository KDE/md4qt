...
#ifndef MD4QT_MD_ATX_HEADING_PARSER_H_INCLUDED
#define MD4QT_MD_ATX_HEADING_PARSER_H_INCLUDED
...
/*!
 * \class MD::ATXHeadingParser
 * \inmodule md4qt
 * \inheaderfile md4qt/atx_heading_parser.h
 *
 * \brief ATX heading parser.
 *
 * ATX heading parser.
 */
class ATXHeadingParser : public BlockParser
{
public:
    ...
    /*!
     * Make a label for heading, append heading to the document.
     *
     * \a paragraph Heading's paragraph.
     *
     * \a path Path.
     *
     ...
     * \a doc Document.
     */
    static void processLabel(QSharedPointer<Paragraph> paragraph,
                             const QString &path,
                             const QString &fileName,
...
#endif // MD4QT_MD_ATX_HEADING_PARSER_H_INCLUDED
