...
TEST_CASE("091")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/091.md"));
...
TEST_CASE("092")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/092.md"));
...
TEST_CASE("093")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/093.md"));
    ...
    REQUIRE(doc->items().at(1)->type() == MD::ItemType::RawHtml);
    auto h = static_cast<MD::RawHtml<TRAIT> *>(doc->items().at(1).get());
    REQUIRE(h->text() == TRAIT::latin1ToString("<!DOCTYPE html> Text"));
    REQUIRE(h->startColumn() == 0);
    REQUIRE(h->startLine() == 0);
    REQUIRE(h->endColumn() == 19);
    REQUIRE(h->endLine() == 0);
...
TEST_CASE("094")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/094.md"));
...
TEST_CASE("095")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/095.md"));
...
TEST_CASE("096")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/096.md"));
...
TEST_CASE("097")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/097.md"));
...
TEST_CASE("098")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/098.md"));
...
TEST_CASE("099")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/099.md"));
...

    {
...

        {
            ...
            auto t = static_cast<MD::Text<TRAIT> *>(p->items().at(0).get());
            REQUIRE(t->opts() == MD::TextWithoutFormat);
            REQUIRE(t->text() == TRAIT::latin1ToString("Text <![CDATA["));
        }

        {
            ...
            REQUIRE(t->opts() == MD::TextWithoutFormat);
            REQUIRE(t->text() == TRAIT::latin1ToString("function matchwo(a,b)"));
        }
...

        {
            ...
            REQUIRE(t->opts() == MD::TextWithoutFormat);
            REQUIRE(t->text() == TRAIT::latin1ToString("if (a < b && a < 0) then {"));
        }

        {
            ...
            REQUIRE(t->opts() == MD::TextWithoutFormat);
            REQUIRE(t->text() == TRAIT::latin1ToString("return 1;"));
        }
    }
...
TEST_CASE("100")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/100.md"));
...
TEST_CASE("101")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/101.md"));
...
TEST_CASE("102")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/102.md"));
...
TEST_CASE("103")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/103.md"));
...
TEST_CASE("104")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/104.md"));
...
TEST_CASE("105")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/105.md"));
...
TEST_CASE("106")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/106.md"));
...
TEST_CASE("107")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/107.md"));
    ...
    REQUIRE(doc->items().at(1)->type() == MD::ItemType::RawHtml);
    auto h = static_cast<MD::RawHtml<TRAIT> *>(doc->items().at(1).get());
    REQUIRE(h->text() == TRAIT::latin1ToString("<form> Text"));
    REQUIRE(h->startColumn() == 0);
    REQUIRE(h->startLine() == 0);
    REQUIRE(h->endColumn() == 10);
    REQUIRE(h->endLine() == 0);
...
TEST_CASE("108")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/108.md"));
...
TEST_CASE("109")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/109.md"));
...
TEST_CASE("110")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/110.md"));
...
TEST_CASE("111")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/111.md"));
...
TEST_CASE("112")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/112.md"));
...
TEST_CASE("113")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/113.md"));
...
TEST_CASE("114")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/114.md"));
...
TEST_CASE("115")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/115.md"));
...
TEST_CASE("116")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/116.md"));
...
TEST_CASE("117")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/117.md"));
...
TEST_CASE("118")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/118.md"));
...
TEST_CASE("118-1")
{
    const auto fileName = TRAIT::latin1ToString("tests/parser/data/118.md");
...
#else
    std::string path;
    std::ifstream stream(fileName.toUTF8String(path), std::ios::in | std::ios::binary);

    typename TRAIT::String wd = std::filesystem::canonical(std::filesystem::current_path()).u8string();
...
TEST_CASE("120")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/120.md"));
