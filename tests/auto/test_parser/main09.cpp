...
TEST_CASE("249")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/249.md"));
...
TEST_CASE("250")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/250.md"));
    ...
    REQUIRE(h->label().startsWith(TRAIT::latin1ToString("#qml_api")));
...
TEST_CASE("251")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/251.md"));
    ...
    REQUIRE(doc->items().at(1)->type() == MD::ItemType::Heading);
    auto h = static_cast<MD::Heading<TRAIT> *>(doc->items().at(1).get());
    REQUIRE(h->label().startsWith(TRAIT::latin1ToString("#heading")));
    REQUIRE(h->text()->items().size() == 1);
    ...
    REQUIRE(t->endLine() == 0);
    REQUIRE(t->text() == TRAIT::latin1ToString("headig"));
}
...
TEST_CASE("252")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/252.md"));
...
TEST_CASE("253")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/253.md"));
...
TEST_CASE("254")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/254.md"));
    ...
    REQUIRE(h->label().startsWith(TRAIT::latin1ToString("#id")));
}
...
TEST_CASE("231-1")
{
    ...
    REQUIRE(t->endLine() == 0);
    REQUIRE(t->text() == TRAIT::latin1ToString("www.google.com"));
}
...
TEST_CASE("255")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/255.md"));
...
TEST_CASE("256")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/256.md"));
...

    {
        REQUIRE(p->items().at(0)->type() == MD::ItemType::Text);
        auto t = static_cast<MD::Text<TRAIT> *>(p->items().at(0).get());
        REQUIRE(t->text() == TRAIT::latin1ToString("Some text"));
        REQUIRE(t->opts() == MD::ItalicText);
...
TEST_CASE("257")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/257.md"));
...
TEST_CASE("258")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/258.md"));
...
TEST_CASE("259")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/259.md"));
    ...
    for (int i = 0; i < 2; ++i)
        REQUIRE(static_cast<MD::ItemWithOpts<TRAIT> *>(p->items().at(i).get())->startColumn() == 2);

    for (int i = 2; i < 5; ++i)
        REQUIRE(static_cast<MD::ItemWithOpts<TRAIT> *>(p->items().at(i).get())->startColumn() == 1);
}
...
TEST_CASE("260")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/260.md"));
...
void check257WithSemiOpt(std::shared_ptr<MD::Document<TRAIT>> doc)
{
...

    {
        REQUIRE(p->items().at(0)->type() == MD::ItemType::Text);
        auto t = static_cast<MD::Text<TRAIT> *>(p->items().at(0).get());
        REQUIRE(t->text() == TRAIT::latin1ToString("some"));
        REQUIRE(t->opts() == MD::ItalicText);
        REQUIRE(t->openStyles().size() == 3);
        REQUIRE(t->openStyles().at(0) == MD::WithPosition{0, 0, 0, 0});
        REQUIRE(t->openStyles().at(1) == MD::WithPosition{1, 0, 1, 0});
...
TEST_CASE("257-1")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/257.md"), false, {TRAIT::latin1ToString("md"), TRAIT::latin1ToString("markdown")}, false);
...
TEST_CASE("257-2")
{
    const auto fileName = TRAIT::latin1ToString("tests/parser/data/257.md");
...
TEST_CASE("261")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/261.md"));
...
TEST_CASE("262")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/262.md"));
...
TEST_CASE("263")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/263.md"));
...
TEST_CASE("264")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/264.md"));
...
TEST_CASE("265")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/265.md"));
...
TEST_CASE("266")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/266.md"));
...
TEST_CASE("267")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/267.md"));
...
TEST_CASE("268")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/268.md"));
...
TEST_CASE("269")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/269.md"));
...
TEST_CASE("270")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/270.md"));
...
TEST_CASE("271")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/271.md"));
...
TEST_CASE("272")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/272.md"));
...
TEST_CASE("273")
{
    ...
    auto doc = parser.parse(TRAIT::latin1ToString("tests/parser/data/273.md"));
